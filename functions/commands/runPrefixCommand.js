...
registerFunction(scriptName, async (command, message, args) => {
  ...
  // options: { quotes: true } on a command lets users quote arguments containing spaces
  ...
  if (command.arguments) {
    try {
      ...
      args = argArray
      // parsed arguments are spread into execute, with any processing message an argtype created appended last
